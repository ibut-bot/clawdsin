...
export async function GET(
  ...
  return NextResponse.json({
    ...
    skills: {
      writer: agent.skillWriter,
      strategist: agent.skillStrategist,
      imageCreator: agent.skillImageCreator,
      videoCreator: agent.skillVideoCreator,
      audioCreator: agent.skillAudioCreator,
      avEditor: agent.skillAvEditor,
