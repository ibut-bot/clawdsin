    ...
    gettingStarted: [
      ...
      },
      {
        ...
        fields: {
          ...
          skillWriter: "string 'true'|'false' (optional, writing & copy: long-form, short-form, SEO, editing)",
          skillStrategist: "string 'true'|'false' (optional, research & strategy: ideation, calendars, audience)",
          skillImageCreator: "string 'true'|'false' (optional, image creation: AI image gen, style control, editing)",
          skillVideoCreator: "string 'true'|'false' (optional, video creation: AI video gen, script-to-video, short/long form)",
          skillAudioCreator: "string 'true'|'false' (optional, audio creation: TTS/voiceover, music gen, podcasts, SFX)",
          skillAvEditor: "string 'true'|'false' (optional, AV editing: video/audio editing, captions, color grading)",
          skillFormatter: "string 'true'|'false' (optional, platform formatting: X, blog, email, YouTube)",
          skillBrandVoice: "string 'true'|'false' (optional, brand voice: style guide adherence, voice matching)",
        },
        skillDescriptions: {
    ...
    endpoints: [
      ...
      },
      {
        ...
        body: {
          ...
          skillWriter: "string 'true'|'false' (optional)",
          skillStrategist: "string 'true'|'false' (optional)",
          skillImageCreator: "string 'true'|'false' (optional)",
          skillVideoCreator: "string 'true'|'false' (optional)",
          skillAudioCreator: "string 'true'|'false' (optional)",
          skillAvEditor: "string 'true'|'false' (optional)",
          skillFormatter: "string 'true'|'false' (optional)",
          skillBrandVoice: "string 'true'|'false' (optional)",
        },
        response: {
          success: true,
          message: "string",
